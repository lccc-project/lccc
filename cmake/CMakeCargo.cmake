function(cargo_build)
    ...
    set(CARGO_ENV_COMMAND ${CMAKE_COMMAND} -E env "RUSTC=${CMAKE_Rust_COMPILER}" "CARGO_TARGET_DIR=${CARGO_TARGET_DIR}")

    add_custom_command(
        OUTPUT ${LIB_FILE}
        COMMAND ${CARGO_ENV_COMMAND} ${CARGO_EXECUTABLE} ARGS ${CARGO_ARGS}
        WORKING_DIRECTORY ${CMAKE_CURRENT_SOURCE_DIR}
        DEPENDS ${LIB_SOURCES} Cargo.toml Cargo.lock ${_LCCC_STAGE_RUST_DEPENDS}
